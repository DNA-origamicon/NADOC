...
def _backbone_bridge_cost_grad(
    ...
    """
    d_c3o3 = o3 - c3
    n_c3o3 = float(_np.linalg.norm(d_c3o3))
    d_o3p = p - o3
    n_o3p = float(_np.linalg.norm(d_o3p))
    d_po5 = o5 - p
    n_po5 = float(_np.linalg.norm(d_po5))
    d_o5c5 = c5 - o5
    n_o5c5 = float(_np.linalg.norm(d_o5c5))
    ...
    u1 = d_c3o3 / _safe(n_c3o3)
    u2 = d_o3p / _safe(n_o3p)
    u3 = d_po5 / _safe(n_po5)
    u4 = d_o5c5 / _safe(n_o5c5)
