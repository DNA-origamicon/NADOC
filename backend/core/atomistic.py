...
# ── Canonical backbone geometry constants moved to atomistic_helpers (Pass 11-A).
# (_CANON_*, _DEG2RAD, _COS_*, _PHOSPHATE_ATOMS imported above.)
...
# Objective weights, soft-sphere contact radius, and chord fractions moved to
# atomistic_helpers (Pass 11-A). _fwd_bridge_x0 and _bwd_bridge_x0 also moved.
...
# Pure-math leaves moved to atomistic_helpers (Pass 11-A):
#   _cos_angle_3pt, _make_spin_rotation, _backbone_bridge_cost,
#   _cos_angle_grad, _backbone_bridge_cost_grad, _spin_rotation_deriv,
#   _glycosidic_cost_grad, _repulsion_cost_grad,
#   _rb_pair_repulsion_grad, _rb_grad_propagate.
# Imported above from backend.core.atomistic_helpers.
...
# _glycosidic_cost, _repulsion_cost, _rb_pair_repulsion moved to
