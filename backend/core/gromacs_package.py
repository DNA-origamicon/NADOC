...
from backend.core.gromacs_helpers import (
    _rename_atom_in_line,  # noqa: F401  (re-exported for back-compat)
    adapt_pdb_for_ff,
...
# Atom-name maps (_RENAMES_CHARMM27, _RENAMES_AMBER) and pure PDB-text helpers
# (_rename_atom_in_line, adapt_pdb_for_ff, strip_5prime_phosphate) moved to
# backend/core/gromacs_helpers.py (Refactor 09-B). Imported above.
...
# ══════════════════════════════════════════════════════════════════════════════
# §2  PDB ATOM-NAME ADAPTATION + 5′-PHOSPHATE STRIPPING
# ══════════════════════════════════════════════════════════════════════════════
# Pure-text helpers (_rename_atom_in_line, adapt_pdb_for_ff,
# strip_5prime_phosphate) moved to backend/core/gromacs_helpers.py
# (Refactor 09-B). Re-imported at the top of this module so existing
# attribute-access (gromacs_package.adapt_pdb_for_ff) continues to work.
