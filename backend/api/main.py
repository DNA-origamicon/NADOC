...
from backend.api.routes_namd_gold import router as namd_gold_router
from backend.api.routes_namd_setup_presets import router as namd_setup_presets_router
...
@app.exception_handler(CpdCapabilityError)
async def _cpd_capability_error_handler(request, exc):
    """Turn the deliberate CPD fail-closed exception into an actionable API error."""
...
app.include_router(namd_gold_router, prefix="/api")
app.include_router(namd_setup_presets_router, prefix="/api")
