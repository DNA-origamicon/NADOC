...
try {
  ...
  console.log('PASS: public DNS, public-relay browser HTTPS, wrong-password rejection, correct-password scene load, navigation, and editor/management isolation. No private DNS or certificate override used.')
} finally {
  await browser?.close()
