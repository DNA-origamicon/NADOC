...
remote_root=${2:-/scratch/alpine/jojo6687/nadoc_qm_campaigns/tt-cpd-local-fragment-continuation-v1}
archive="$campaign_root/alpine-local-fragment-continuation-v1.tar.gz"
...
systemd-run --user --collect \
  --unit=nadoc-alpine-local-fragment-frequency-watch \
  --property=Restart=no \
