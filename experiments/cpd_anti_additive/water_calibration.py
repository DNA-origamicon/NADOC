...
def prepare(root):
    ...
    for endpoint in (1, 2):
        esp = ART / f"cpd-anti-boundary-esp-v2/endpoint-{endpoint}/job_manifest.json"
    ...
    write(
        ...
        dict(
            records=records,
            scope="Three representative sites per endpoint, identical-geometry DF/DIRECT calibration; not interaction curves or charge validation",
