...
def prepare(root, ordered=False):
    ...
    chargepath = ART / "cpd-anti-multiconformer-water-charge-v1/assessment.json"
        ...
        jobs.append(
            dict(
                ...
                command=[
                    ...
                    str(REPO / "experiments/cpd_anti_additive/refine_remote_reference.py"),
                    "--root",
    ...
    write(
        ...
        dict(
            ...
            scope="Bounded geometry refit for three multiconformer charge hypotheses using lower-energy endpoint2 reference; original reference remains validation; no acceptance",
            simulation_ready=False,
        ),
    )
