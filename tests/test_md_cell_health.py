...
def test_a_correctly_filled_box_passes():
    ...
    rows = _trace([(0, 1.0), (100, 0.95), (200, 0.930), (300, 0.926),
                   (500, 0.926), (800, 0.9265), (1000, 0.926)])
...
def test_box_from_envelope_honours_padding_and_percentile():
    ...
    assert box_from_envelope(env, 1.2, mode="axis", percentile="p50") == \
