...
def _design_diff_length_overhangs() -> Design:
    ...
    return Design(helices=[hdrv, hdrvn], strands=[st_drv, st_drvn], overhangs=[ohd, ohn])
...
def test_connect_relocates_short_driven_onto_long_driver_helix():
    ...
    r = client.post("/api/design/duplexes/connect", json={
        "overhang_a_id": "OHd", "overhang_a_attach": "root",
        "overhang_b_id": "OHn", "overhang_b_attach": "root",
    })
