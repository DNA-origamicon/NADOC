...
def _build_cov_maps(design):
    ...
    for strand in design.strands:
        st = (
            ...
            if hasattr(strand.strand_type, "value")
...
class TestDomainEndDetection:
    def test_unrelated_adjacent_strand_does_not_hide_overhang_end(self):
        ...
        design = Design(
            ...
            overhangs=[
                OverhangSpec(id="ovhg0", helix_id="h0", strand_id="overhang_strand")
            ],
        )
...
class TestSnapshotCounts:
    ...
    def test_hinge(self):
        ...
        assert c["with_overhang"] == 72, (
            f"hinge with_overhang={c['with_overhang']}, expected 72"
        )
    ...
    def test_voltron(self):
        ...
        assert c["with_overhang"] == 78, (
            f"voltron with_overhang={c['with_overhang']}, expected 78"
        )
