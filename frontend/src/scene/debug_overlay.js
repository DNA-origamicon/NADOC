...
export function initDebugOverlay(canvas, camera, designRenderer, opts = {}) {
  ...
  function _nucHtml(nuc) {
    ...
    s += _row('type:', nuc.strand_type ?? 'unassigned', nuc.strand_type === 'scaffold' ? '#0070bb' : '#ffcc80')
  ...
  function _bondHtml(cone) {
    ...
    s += _row('type:', f.strand_type ?? 'unassigned', f.strand_type === 'scaffold' ? '#0070bb' : '#ffcc80')
