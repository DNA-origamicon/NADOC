...
function inp(placeholder, value = '', style = '') {
  ...
  // reaching the global keydown dispatcher — otherwise single-key view/tool
  // shortcuts fire mid-typing. Same-element Enter/Escape handlers attached by
  // callers still run; stopPropagation only blocks bubbling to document.
