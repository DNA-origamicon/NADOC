...
## Hygiene migration snapshot — 2026-08-08

The following material was removed from the scan-only index during the memory hygiene migration. Existing stable-ID entries above remain canonical where duplicated.
