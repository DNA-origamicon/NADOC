---
name: overhang-connections-panel-archive
description: "History for [[overhang-connections-panel]] — the incremental 2026-06-28..06-30 build log of the Overhang Connections sidebar section, including the superseded end-to-root splice model. KNOWN-STALE; read the head instead."
metadata:
  node_type: memory
  type: project
---

# Overhang Connections panel — ARCHIVE (build history)

> **KNOWN-STALE. Do not read this in a routine loop.** Current state, code locations,
> the length fork and the live open items are in `project_overhang_connections_panel.md`.
> Kept only to mine a specific past decision. Everything from the "Apply ⇄ Unapply"
> bullet onward describes the **OLD end-to-root splice model**, deleted 2026-06-30.
