# Alpine cluster submission — archive (phase detail, run logs, resolved debugging)

Split out of `memory/project_alpine_cluster_submission.md` on 2026-07-09 for context economy.
