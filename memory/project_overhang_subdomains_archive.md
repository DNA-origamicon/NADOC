# Overhang sub-domains — ARCHIVE (history; do not read in a routine loop)

**Known-stale.** This is the verbatim 2026-05-10/05-11 phase log for Phases 1-7, preserved for
mining specific past decisions. It was written in-flight and audited 2026-07-31; several of its
claims are now WRONG (notably: Phase 5's "flipping `bound` freezes the joint at the computed
angle" was reverted at user request 2026-05-14, and Phase 6 shipped under a different
architecture). **Read `project_overhang_subdomains.md` (the head) instead.** Open this only for a
named past decision.
