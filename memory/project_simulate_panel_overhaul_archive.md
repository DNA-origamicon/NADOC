# Simulate-panel overhaul — ARCHIVE (history)

History for [[project_simulate_panel_overhaul]]. **Never read in a routine loop** — open only to
mine a specific past decision. Current state, open items and rank live in the head file.
