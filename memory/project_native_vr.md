...
- Next slice: finish bond/backbone identity semantics, then add cross-representation selected-owner projection. Phase 1 and Phase 3 remain pending their manual headset gates.
