...
- Next slice after the Phase 4 headset gate: begin Phase 5 with a transactional in-headset tool shell (selection summary, preview, confirm, cancel, and desktop undo), before wiring extrude/twist/bend/move-rotate mutations. Phase 1 and Phase 3 remain pending their manual headset gates.
...
Wait for the consolidated Phase 4 headset result. On Go, begin Phase 5 with a read-only transactional tool shell and shared preview/confirm/cancel/undo contract before exposing any mutation. Preserve v4-v7 readers and v8 owner parity; Phase 1 and Phase 3 remain at their manual gates.
