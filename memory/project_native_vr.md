...
- Next slice: cover atom/linker/flexible identity adapters and specify a non-conflicting click gesture before allowing canonical selection writes. Phase 1 and Phase 3 remain pending their manual headset gates.
...
Resolve atom/linker/flexible primitive owners into transient desktop descriptors, then decide the click gesture around the existing trigger-grab conflict. Phase 1 and Phase 3 stay at manual gates until the headset checklists above pass.
