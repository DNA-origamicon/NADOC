...
- Next slice: add browser-confirmed selected-owner feedback to the native scene, then finish bond/backbone identity semantics. Phase 1 and Phase 3 remain pending their manual headset gates.
