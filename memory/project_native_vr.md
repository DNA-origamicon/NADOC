...
- Next slice: add cross-representation selected-owner projection, then complete the Phase 4 selection matrix and manual gate. Phase 1 and Phase 3 remain pending their manual headset gates.
