...
History and superseded detail split out of `project_photo_mode.md` on 2026-07-29.
**Most of this describes photo mode v1**, whose source now lives verbatim under
`frontend/archive/photo_mode_v1/` — read that README first. Mine this file for a
specific past decision; never read it in a routine loop.
