...
**Native FEM shape predictor:** [cando_fem](project_cando_fem.md) — CanDo-replica twist/curvature/RMSF FEM, zero export. Phase 0 DONE (GO w/ conditions: user runs CanDo web for ref data; "1-to-1"=stated tolerance; NO twist-stretch coupling). Revives archived `fem_solver.py`.
