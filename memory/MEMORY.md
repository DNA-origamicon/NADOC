...
**atomistic_source_of_truth** (PLAN, P0 — invert the dependency: atomistic becomes THE source, the full/CG rep becomes purely derived + figure-tuned and may never reach a simulation. READ BEFORE any geometry, atomistic or sim-seed work)
