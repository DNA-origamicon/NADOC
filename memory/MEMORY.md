...
**Display / representation:** [ssdna_flexible_segments](project_ssdna_ball_joints.md) (flexible UNPAIRED runs → arc, free-until-taut drag) · [photo_mode](project_photo_mode.md) (PBR+HDRI+SSS; PMREM rebake; PT BVH caveat) · [hull_prism](project_hull_prism.md) (distance-LOD boxes/prisms, dsDNA-only) · [mixed_representation](project_mixed_representation.md) (PLAN: per-nucleotide rep resolution) · [strand_animations](project_strand_animations.md) (`/strand-anim.html` un/hybridization) · [reference_geometry](project_reference_geometry.md) (per-strand `is_reference`; translucent, excluded) · [protein_attachment](project_protein_attachment.md) (import PDB proteins, attach to overhangs — display; Phase 1 shipped, 2–4 unbuilt) · [headless_build](project_headless_build.md) (mouse-free bundle/extrude API + conftest test-design builders) · [sphere_impostors](project_sphere_impostors.md) (bead/atom quads +gl_FragDepth, `?impostors=1`)

**Overhangs / linkers:** [overhang_subdomains](project_overhang_subdomains.md) · [overhang_connections](project_overhang_connections.md) · [overhang_binding_extensions](project_overhang_binding_extensions.md) · [assembly_overhang_bindings](project_assembly_overhang_bindings.md) · [assembly_linker_relax](project_assembly_linker_relax.md) (transform-only guard gotcha) · [bond_relax](project_bond_relax.md) (`POST /design/relax-bond`) · [ball_joint](project_ball_joint.md) (scoped, no code) · [ct_tab](project_ct_tab.md) · [overhang_connections_panel](project_overhang_connections_panel.md) (CT picker v1) · [ssdna_linker_relax](project_ssdna_linker_relax.md) (FJC) · [oh_binder](project_oh_binder.md) (`Domain.binds_overhang_id`; scaffold-coverage fix) · [overhang_lookup_infra](project_overhang_lookup_infra.md) · [overhang_generation](project_overhang_generation.md) · [mate_connectors](project_mate_connectors.md) · [domain_ends_refactor](project_domain_ends_refactor.md) · [overhang_sequence_display](project_overhang_sequence_display.md) (`assembleOverhangSequence`; `reassign_if_sequenced` auto-RC) · [overhang_duplex_foundation](project_overhang_duplex_foundation.md) (**Duplex graph; read before touching overhang pairing**) · [overhang_duplex_cluster](project_overhang_duplex_cluster.md) (movable child cluster, constrained Move/Rotate)
...
**Scaffold / seam / autostaple:** [hinge_autoscaffold](project_hinge_autoscaffold.md) (**REGRESSION GATE `scaffold_invariants.py`**; hinge routers seamed+seamless for even k×N; `build_hinge(k,n)`; **add new autoscaffold paths to ROUTING_ENTRY_POINTS**) · [autoscaffold_single_strand](project_autoscaffold_single_strand.md) (ISSUE-8: uniform sub-bundles + 2-opt splice; in progress) · [scaffold_router](project_scaffold_router.md) (CSP, bulge stub) · [seamless_router](project_seamless_router.md) · [dumbbell_autoscaffold](project_dumbbell_autoscaffold.md) (visual bug; resume guide inside) · [autostaple_bugs](project_autostaple_bugs.md) (resolved) · [forced_ligation](project_forced_ligation.md) (merged) · [advanced_staple_disabled](project_advanced_staple_disabled.md) (fallback to basic)

**Cluster submission (CURC Alpine):** [alpine_cluster_submission](project_alpine_cluster_submission.md) (**ALL 5 PHASES SHIPPED + live-validated 2026-07-03**; MD→Alpine SSH+SLURM; review-card submit w/ auto-resources; seam = `MdJob.execution_target` branch; whole-ladder single sbatch. **Timeout→resumable (paused); user-driven Resume from mid-segment NAMD checkpoint via the same review card — NOT automatic (Duo needs the user)**; learned ns/day; queued ⧗ icon + wait tooltip. **Read the "Resume model" block before touching resume logic.** Open follow-ups: embedded `alpine_profile()` still lists the phantom `atesting_a100` (dropped only via `workspace/clusters.json`); GPU NAMD module name + live `sinfo` partition discovery still unconfirmed)

**MD (NAMD+oxDNA):** [lammps_oxdna](project_lammps_oxdna.md) (**LAMMPS+CG-DNA = CPU-parallel MPI oxDNA for very large assemblies. P1 detect/panel/doctor + P2 native converter+runner + P3 managed job & REST + P4 UI section + P5 trajectory read-back + P6 full "Visualizations & processing" card (oxDNA parity: display/flexibility-RMSF/deviation/trajectory + Align, driven through the SAME validated oxdna_health backend + oxdna_display pure mappers via `lammps_display.js`; dump→`.dat` transcode = every oxDNA reader works verbatim) SHIPPED & live-verified (14.5k-nt design, all views ready; serial). MPI parallel run still unverified — needs `libopenmpi-dev`. Remaining: force mapping, torque protocol**; `lammps_interface.py` transcodes NADOC oxDNA top/conf→LAMMPS data (`exyz_to_quat` verbatim from LAMMPS generate.py); `lammps_runner.py`+`lammps_job.py`+`routes_lammps.py`+`ui/lammps_jobs_{panel,logic}.js`; `find_lammps`+`lammps_supports_cgdna`) · [oxpy_binding_patch](project_oxpy_binding_patch.md) (oxpy patched for `BaseForce.F0/.dir`; reapply after rebuild) · [proteins_in_simulation](project_proteins_in_simulation.md) (PDB proteins in oxDNA ANM fork + MD; CPU fork `~/anm-oxdna`) · [oxdna_efield](project_oxdna_efield.md) (E-field per-nt forces+traps; no GPU) · [oxdna_relaxation](project_oxdna_relaxation.md) (CUDA 3-stage relax + surface/anchors; KEYSTONE `fix_diffusion=false`) · [benchmark_tuning](project_benchmark_tuning.md) (MV-BENCH) · [md_engines_panel](project_md_engines_panel.md) (MV-ENGINES)

**MrDNA / ARBD:** [mrdna_arbd_setup](project_mrdna_arbd_setup.md) (install paths, 5 py3.13 patches, re-patch script) · [mrdna_bead_model](project_mrdna_bead_model.md) (**CRITICAL: 1 DNA bead per bp not per nt**; per-helix) · [mrdna_panel](project_mrdna_panel.md) (Dynamics-tab CG job panel: Coarse/Fine, deform+beads-with-bonds displays; Fine=real `multiresolution_simulation`; curvature ~18% under Dietz — LESSONS A9; MV-MRDNA-JOBS)

**oxDNA CG:** [oxdna_benchmarks](project_oxdna_benchmarks.md) (CPU timing, box sizing) · [oxdna_extra_bases](project_oxdna_extra_bases.md) (`Crossover.extra_bases`→ssDNA inserts; **phantom-FENE-bond gotcha**) · [skip_twist_selfconsistency](project_skip_twist_selfconsistency.md) (tune SQ skip period → oxDNA mean matches analytic) · [regional_autorefine](project_regional_autorefine.md) (Phase 5 non-uniform skip; 5.0/5.1 green) · [skip_twist_curvature_sweep](project_skip_twist_curvature_sweep.md) (exp31 sweep DONE; **CUDA-proxy fails→use real CUDA**; exp32=`profile_guided_refine.py`) · [md_twist_validation](project_md_twist_validation.md) (exp33 atomistic validation of oxDNA twist)
...
**NAMD production / solvation:** [btube_benchmark](project_btube_benchmark.md) (GPU PME disabled; dt trick) · [periodic_cell](project_periodic_cell.md) (5 failure modes) · [namd_solvate](project_namd_solvate.md) (GMX solvate→PSF merge→NAMD) · [water_shell_carve](project_water_shell_carve.md) (drop bulk water for 12GB GPU) · [3x4sq_md_run](project_3x4sq_md_run.md) (SQ health-fail root cause) · [exp30_18hb_production](project_exp30_18hb_production.md) (224-strand; topology scale bugs)
...
**MD job system / runners:** [md_job_system](project_md_job_system.md) (`md_job.py`, `namd_runner`, `routes_md`; `/api/md/`) · [md_prep_relaxation](project_md_prep_relaxation.md) (exp29 prep harness; ENM k-release; read HANDOFF first) · [oxdna_metrics_card](project_oxdna_metrics_card.md) (Graphs+Metrics card: twist/curvature/bp graphs+export; shipped 2026-07-02, MV-20)

**MD visualization / overlay:** [md_viz_tools](project_md_viz_tools.md) (trajectory + RMSF map; reuse oxDNA display controller; **per-frame extraction de-unwrapped 2026-07-02, ~15000× faster**) · [md_panel_status](project_md_panel_status.md) (stale-Universe + PBC artifacts) · [md_sidebar_audit](project_md_sidebar_audit.md) (R1–R12; R1/R2 fixed) · [md_live_model_cache](project_md_live_model_cache.md) (single-flight `atomistic_cache.py` fixes ~20GB pile-up)

**Automation / jobs infra:** [staleness_diagnostics](project_staleness_diagnostics.md) (**"design changed, can't continue" compares vs LIVE loaded design → restart/wrong-design spuriously flags; check `GET /api/design` first**; `describe_staleness` names different-design vs edited) · [af25_af26_job_log_sync](project_af25_af26_job_log_sync.md) (roll/return lifecycle; COMPLETE) · [job_activity_spinner](project_job_activity_spinner.md) (`/api/jobs/active` + spinner) · [job_disk_usage](project_job_disk_usage.md) (welcome disk column) · [job_archive](project_job_archive.md) (`job_dir()` archive-awareness invariant)
...
**Assembly overhaul (12 phases shipped):** [assembly_overhaul](project_assembly_overhaul.md) · [assembly_part_context](project_assembly_part_context.md) · [assembly_groups](project_assembly_groups.md) (PartGroups, .nass v2) · [gear_relations](project_gear_relations.md) (couple revolute joints, live RPM) · [belt_paths](project_belt_paths.md) (display-only P1) · [route_for_polymerization](project_route_for_polymerization.md) (fill ends→periodic-seam; cadnano editor own api.js) · [polymerize_origami](project_polymerize_origami.md) · [path_to_thousands](project_path_to_thousands.md) (**assembly scale, shared renderer DEFAULT; read before touching assembly**) · [session_recovery](project_session_recovery.md) (P1 restart recovery + P2 multi-doc `doc_context`)
