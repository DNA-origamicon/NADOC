...
**atomistic_source_of_truth** (P0 — the stamp no longer reads the display bead (2026-08-07); carries the audit table of every CG coupling still live. READ BEFORE any geometry, atomistic or sim-seed work) ·
**helical_site** (P0 — one site abstraction all reps project from; Phases 0-6 DONE; 7-10 open, 7+8 need a decision. Read with the above)
