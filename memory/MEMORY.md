...
**Development cleanup:** [development_artifact_cleanup](feedback_development_artifact_cleanup.md) — delete disposable test outputs; retain useful evidence in isolated experiment workspaces, never the main user workspace.
